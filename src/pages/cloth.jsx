...
import { products } from '../products/gunProducts.js';
    ...
    return (
        <>
            ...
            <div className="menu">
                ...
                <ProductCard products={products.cloth.productsOne} activeCategory={activeMenuOne} />
                ...
                <ProductCard products={products.cloth.productsTwo} activeCategory={activeMenuTwo} />
            </div>
            <OllAll />
            <Mail/>
        </>
